function SDF_char(user_name,input_type,file_name)
...
user_activity = [time_now,' ',(user_name),' ','Characterization - SDF',' ',Job_ID];
...
path_to_write = ['/var/www/html/nm/SDF/Characterization/',Job_ID];
mkdir(path_to_write);
...
Body2 = '<p>You are receiving this email because you had submitted an image for characterization using Spectral Density Function.';
Body3 = ['The characterization process is complete and you can view the results','<a href= http://nanomine.northwestern.edu:8000/SDFchar_view_Result.html?foo=',num2str(Job_ID),'&submit=Send> here</a></p>'];
